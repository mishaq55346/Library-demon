...
import com.company.requests.AGReader;
import com.company.requests.CGBookStatus;
import com.company.requests.GetBooks;
import com.company.requests.IsBookInStock;
import com.company.library.ReaderR;
import com.company.library.Book;
import com.company.library.BookStatus;
        ...
        try {
            ...
            while (//!toClient.isClosed() &&
                ...
                switch (var = scanner.nextInt()){
                    case 1: {
                        jsonString="{ \"method\" : \"com.company.requests.GetBooks\", \"title\" : \"u\", \"author\" : null, "+
                    ...
                    case 4: {
                        jsonString="{ \"method\" : \"com.company.requests.IsBookInStock\", \"book_id\" : \"5\"}";
                        break;
                    }
                }
                ...
                //парсю их в json
                switch(method){
                    case "com.company.requests.GetBooks": {
                    ...
                    case "com.company.requests.IsBookInStock": {
